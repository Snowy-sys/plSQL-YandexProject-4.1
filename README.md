...
## Ревью
Результат ревью и отзыв по проекту размещен в [Comments.txt](https://github.com/Snowy-sys/plSQL-YandexProject-4.1/blob/main/Comments.txt)
...
#### Предусловия
Перед началом выполнения заданий необходимо развернуть базу данных из дампа. Дамп весит больше 25 мб, готов предоставить по запросу. Реализация всех заданий представлерна в [СР_4_1](https://github.com/Snowy-sys/plSQL-YandexProject-4.1/blob/main/%D0%A1%D0%A0_4_1.sql)
